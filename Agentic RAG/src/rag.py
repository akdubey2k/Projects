...
class RAGSystem:
    ...
    # retriever=self.vector_store.as_retriever(search_kwargs={"k": 4}): Configures the retriever
    # to return the top 4 most relevant chunks/documents.
    # 
    ...
    # Query the QA system with a question and get an answer.
    # Main interface for asking questions to the RAG system.
    # Validates if the QA chain is initialized before processing the query.
    # question: User's question to be answered based on the documents.
    # Format query for the chain. Extract result from response
